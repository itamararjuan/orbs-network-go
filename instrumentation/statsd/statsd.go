...
// Copied as-is from https://github.com/statsd/statsd/blob/master/examples/go/statsd.go
// From commit 5feea5e637baa2c694f3a5448a0f3ca6cc52b137 (Jun 22, 2015)
...
func StatsdInstance() *StatsdClient {
	if client == nil {
		client = New("127.0.0.1", 8125)
	}
	return client
}
